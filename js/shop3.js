var main = function() {
  ...
  $(".estimate").hide();
  myDataRef.child("rate3").on('value', function (snapshot) {
...
$('#rate1').click(function(){
  ...
  myDataRef.child("rate3").update({number1: counting1});
  $('#count1').html(counting1);
  close();
});
$('#rate2').click(function(){
  counting2 = counting2 + 1;
  myDataRef.child("rate3").update({number2: counting2});
  $('#count2').html(counting2);
  close();
});
$('#rate3').click(function(){
  counting3 = counting3 + 1;
  myDataRef.child("rate3").update({number3: counting3});
  $('#count3').html(counting3);
  close();
});
$('#rate4').click(function(){
  counting4 = counting4 + 1;
  myDataRef.child("rate3").update({number4: counting4});
  $('#count4').html(counting4);
  close();
});
$('#rate5').click(function(){
  counting5 = counting5 + 1;
  myDataRef.child("rate3").update({number5: counting5});
  $('#count5').html(counting5);
  close();
});
